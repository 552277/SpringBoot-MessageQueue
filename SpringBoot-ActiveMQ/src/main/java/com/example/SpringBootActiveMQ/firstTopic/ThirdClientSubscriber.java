 ...
 */
public class ThirdClientSubscriber {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connection.setClientID("thirdDeviceId"); //持久订阅需要设置这个。
            connection.start();
            ...
            fourthConsumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message msg) {
                    ...
                    try {
                        ...
                        System.out.println("第三个客户端上的持久订阅 fourthConsumerId 收到消息： " + message.getText());
                        session.commit();
            ...
            fiveConsumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message msg) {
                    ...
                    try {
                        ...
                        TextMessage message = (TextMessage) msg;
                        System.out.println("第三个客户端上的非持久订阅，fiveConsumerId 收到消息： " + message.getText());
